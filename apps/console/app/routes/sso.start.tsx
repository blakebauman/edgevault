...
/**
 * Begin enterprise SSO: ask the auth worker (via service binding) for the IdP
 * authorize URL + PKCE/state/nonce, stash those server-side in the SSO
...
export async function loader({ request, params, context }: Route.LoaderArgs) {
  ...
  const res = await env.AUTH_SERVICE.fetch(`https://auth/orgs/${orgId}/sso/start`, {
    method: 'POST',
